...
namespace RE
{
	...
	void TESNPC::ChangeHeadPart(BGSHeadPart* a_target)
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(24246, 24750) };
	...
	BGSHeadPart** TESNPC::GetBaseOverlays() const
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(24275, 24791) };
		return func(this);
	}
	...
	std::uint32_t TESNPC::GetNumBaseOverlays() const
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(24276, 24792) };
		return func(this);
	}
	...
	bool TESNPC::HasOverlays()
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(24274, 24790) };
		return func(this);
	}
	...
	void TESNPC::SetSkinFromTint(NiColorA* a_result, TintMask* a_tintMask, bool a_fromTint)
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(24206, 24710) };
	...
	void TESNPC::UpdateNeck(BSFaceGenNiNode* a_faceNode)
	{
		...
		REL::Relocation<func_t> func{ RELOCATION_ID(24207, 24711) };
