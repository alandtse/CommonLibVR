...
namespace RE
{
	...
	NiPointer<Actor> PlayerCharacter::GetActorDoingPlayerCommand() const
	{
		if SKYRIM_REL_CONSTEXPR (REL::Module::IsVR()) {
			...
			return REL::RelocateMemberIfNewer<ActorHandle>(SKSE::RUNTIME_SSE_1_6_629, this, 0x894, REL::AE1799Shift(0x89C)).get();
		}
	}
	...
	NiPointer<TESObjectREFR> PlayerCharacter::GetGrabbedRef(VR_DEVICE a_device)
	{
		if SKYRIM_REL_CONSTEXPR (Module::IsVR()) {
			...
			return REL::RelocateMemberIfNewer<ObjectRefHandle>(SKSE::RUNTIME_SSE_1_6_629, this, 0x8C8, REL::AE1799Shift(0x8D0)).get();
		}
	}
	...
	bool PlayerCharacter::HasActorDoingCommand() const
	{
		if SKYRIM_REL_VR_CONSTEXPR (REL::Module::IsVR()) {
			...
			return static_cast<bool>(REL::RelocateMemberIfNewer<ActorHandle>(SKSE::RUNTIME_SSE_1_6_629, this, 0x894, REL::AE1799Shift(0x89C)));
		}
	}
	...
	bool PlayerCharacter::IsGrabbing() const
	{
		if SKYRIM_REL_CONSTEXPR (Module::IsVR()) {
			...
			return static_cast<bool>(REL::RelocateMemberIfNewer<ObjectRefHandle>(SKSE::RUNTIME_SSE_1_6_629, this, 0x8C8, REL::AE1799Shift(0x8D0)));
		}
	}
